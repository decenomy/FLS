#!/usr/bin/env python3
# Copyright (c) 2019 The Flits Core developers
...
from fake_stake.base_test import flits_FakeStakeTest

class zflswrappedSerialsTest(flits_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zflss..." % DENOM_TO_USE)
