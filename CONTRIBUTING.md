Contributing to FLS Core
============================

The FLS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FLS Core project, and is not to be
confused with overall FLS Network Protocol consensus changes.

Whether a pull request is merged into FLS Core rests with the project merge
...
Patches that change FLS consensus rules are considerably more involved than
...
Where a patch set proposes to change the FLS consensus, it must have been
...
The project leader is the release manager for each FLS Core release.
