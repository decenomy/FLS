...
<context>
    ...
    <message>
        ...
        <translation>Це ваші flits адреси для отримання платежів. Для кожної транзакції рекомендується використовувати нову адресу одержувача.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>flits зараз закриється, щоб завершити процес шифрування. Пам'ятайте, що шифрування гаманця не може повністю захистити ваші FLS'и від крадіжки зловмисним програмним забезпеченням, що заражає ваш комп'ютер.</translation>
    </message>
    <message>
