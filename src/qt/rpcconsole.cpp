                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzFLSPathCustom = GetArg("-zflsbackuppath", "");
    ...
    if(!strzFLSPathCustom.empty()) {
        ui->wallet_customzflsbackuppath->setText(QString::fromStdString(strzFLSPathCustom));
        ui->wallet_customzflsbackuppath_label->setVisible(true);
        ui->wallet_customzflsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzFLSPathCustom.empty()) && nCustomBackupThreshold > 0) {
