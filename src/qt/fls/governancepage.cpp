...
#include "qt/fls/governancepage.h"
#include "qt/fls/forms/ui_governancepage.h"
...
#include "qt/fls/proposalframe.h"
...
GovernancePage::GovernancePage(FLSGUI *parent) :
                                                  PWidget(parent),
...
void GovernancePage::updateProposalList()
{
    ...
    int nBlockStart = pindexPrev->nHeight - pindexPrev->nHeight % GetBudgetCycleBlocks() + GetBudgetCycleBlocks();
    int nBlocksLeft = nBlockStart - pindexPrev->nHeight;
    int nBlockEnd = nBlockStart + GetBudgetCycleBlocks() - 1;
