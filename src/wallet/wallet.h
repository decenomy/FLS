...
extern bool fGlobalUnlockSpendCache; // Bool used for letting the precomputing thread know that zflsspends need to use the cs_spendcache
...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 FLS at the same time
...
enum ZerocoinSpendStatus {
    ...
    ZFLS_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
...
public:
    ...
    std::string GetUniqueWalletBackupName(bool fzflsAuto) const;
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzFLSTracker> zflsTracker;
    ...
    {
        zwalletMain = zwallet;
        zflsTracker = std::unique_ptr<CzFLSTracker>(new CzFLSTracker(strWalletFile));
    }

    CzFLSWallet* getZWallet() { return zwalletMain; }
    ...
    void setZFlsAutoBackups(bool fEnabled)
    {
