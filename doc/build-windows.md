...
Acquire the source in the usual way:
    ...
    git clone https://github.com/SimpleSoftwareSolutions/FLS.git
    cd FLS
...
example /usr/src/FLS, AND not under /mnt/d/. If this is not the case the dependency autoconf scripts will fail.
