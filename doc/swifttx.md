...
This mechanism has been integrated into Bitcore-Node-sssolutions which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sssolutions-Project/insight-api-sssolutions#web-socket-api](https://github.com/sssolutions-Project/insight-api-sssolutions#web-socket-api) 
* API: [https://github.com/sssolutions-Project/insight-api-sssolutions#swifttx-transactions](https://github.com/sssolutions-Project/insight-api-sssolutions#swifttx-transactions) 
...
By default, the SSSolutions Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SSSolutions Core daemon:
