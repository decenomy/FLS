...
This mechanism has been integrated into Bitcore-Node-FLSolutions which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/FLSolutions-Project/insight-api-FLSolutions#web-socket-api](https://github.com/FLSolutions-Project/insight-api-FLSolutions#web-socket-api) 
* API: [https://github.com/FLSolutions-Project/insight-api-FLSolutions#swifttx-transactions](https://github.com/FLSolutions-Project/insight-api-FLSolutions#swifttx-transactions) 
...
By default, the FLSolutions Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FLSolutions Core daemon:
