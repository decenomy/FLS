...
In order to support loading of multiple wallets in flits-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is FLSolutions.cpp.
...
Changes to FLSolutions.cpp
----------------------
FLSolutions.cpp is the entry point into flits-qt, and as such, will require some minor modifications to provide hooks for
