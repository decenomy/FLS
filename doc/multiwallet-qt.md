...
In order to support loading of multiple wallets in sssolutions-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sssolutions.cpp.
...
Changes to sssolutions.cpp
----------------------
sssolutions.cpp is the entry point into sssolutions-qt, and as such, will require some minor modifications to provide hooks for
