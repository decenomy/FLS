...
In order to support loading of multiple wallets in fls-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fls.cpp.
...
Changes to fls.cpp
----------------------
fls.cpp is the entry point into fls-qt, and as such, will require some minor modifications to provide hooks for
