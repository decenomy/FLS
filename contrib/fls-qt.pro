...
TRANSLATIONS += src/qt/locale/flits_bg.ts \
                src/qt/locale/flits_de.ts \
                src/qt/locale/flits_en.ts \
                src/qt/locale/flits_es.ts \
                src/qt/locale/flits_fi.ts \
                src/qt/locale/flits_fr.ts \
                src/qt/locale/flits_it.ts \
                src/qt/locale/flits_ja.ts \
                src/qt/locale/flits_pl.ts \
                src/qt/locale/flits_pt.ts \
                src/qt/locale/flits_ru.ts \
                src/qt/locale/flits_sk.ts \
                src/qt/locale/flits_sv.ts \
                src/qt/locale/flits_vi.ts \
                src/qt/locale/flits_zh_CN.ts \
                src/qt/locale/flits_zh_TW.ts
